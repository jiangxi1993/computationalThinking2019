...
def show_stats_r6_loaded(looptimes,types):
  no_of_rolls = 10000
  f=open("p1data_"+types+".csv", "a+")
  ...
  for i in range(0, no_of_rolls):
    if types=="uniform":
      roll = r6_loaded() # call your function 
       ...
       roll = r6_loaded_rand() # call your function 
  ...
  # print stats
  for i in range(0, 10):
    print(types+","+str(looptimes) + ","+str(i) + "," + str(count_list[i]) + "," + str(no_of_rolls) + "," + str(count_list[i]/no_of_rolls*100))
    f.write(types+","+str(looptimes) + ","+str(i) + "," + str(count_list[i]) + "," + str(no_of_rolls) + "," + str(count_list[i]/no_of_rolls*100)+ ",\n")
  f.close() 
# --------------------------------------------  
# actual code that runs 
print("Running show_stats_r6_loaded")
for i in range(5001):
  show_stats_r6_loaded(i,"uniform")

for i in range(5001):
  show_stats_r6_loaded(i,"random")
